Integrates Drupal with Mixpanel by recording many common Drupal events and providing a simple API for setting defaults for Users and for recording custom events via a PHP and Javascript API.
